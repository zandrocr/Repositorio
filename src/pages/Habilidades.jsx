        ...
        <div id='habilidades' className='background col-12 d-flex justify-content-center'>
            <div className="page col-11 d-flex flex-column justify-content-around">
                <div className='lingua col-12 d-flex flex-column flex-sm-row align-items-center'>
                    ...
                    <div className='col-12 col-sm-6 text-center text-sm-start' data-aos="zoom-in-up" data-aos-duration="2000">
                        <p>
                ...
                <div className='col-12 d-flex justify-content-end' data-aos="zoom-in-up" data-aos-duration="2000">
                ...
                <div className='col-12 d-flex justify-content-sm-end'  data-aos="zoom-in-up" data-aos-duration="2000">
                    <span className='svg col-8 col-sm-5 d-flex justify-content-between'>
                        <SiVisualstudiocode />
                        <SiYarn />
                        <FaGitAlt />
